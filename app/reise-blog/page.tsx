    ...
    <div className="min-h-screen bg-white">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}
        ...
        <div className="relative z-10 text-center px-4 sm:px-8">
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl text-white mb-4">Travel Blog</h1>
          <p className="text-white/80 text-base sm:text-lg">Inspiration for your next luxury trip</p>
        </div>
      </motion.div>
